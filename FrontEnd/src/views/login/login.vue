<template>
  <div class="absolute loginModal flex justify-center items-center w-screen h-screen z-50">
    <div
      class="absolute bg-white z-50 rounded-lg py-8 px-10"
    ...
    <p class="absolute px-7 py-5 text-xl cursor-pointer" style="top:0; right:0" @click="closeLoginModal()">X</p>
      <p
        class="text-3xl tracking-widest font-semibold font-chakra"
        style="color: #636161"
      >
        Welcome !
      </p>
      ...
      <div class="w-full" style="width: 500px">
        <label class="relative block p-4">
          ...
          >
            <img
              width="25px"
              src="../../../src/assets/username-icon.svg"
              alt=""
            />
          </span>
          <input
        ...
        <button
            ...
            <p class="font-chakra tracking-wide" style="color:#817A7A">Not an FastFlight member?   
                <span class="font-chakra tracking-widest font-semibold cursor-pointer" style="color:#454444"> Sign up now</span>
                </p>
            </div>
        </div>
      </div>
    ...
    <div
      class="w-full h-full"
      style="background-color: #787373; opacity: 75%"
    ></div>
  </div>
</template>
<script>
